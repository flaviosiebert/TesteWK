...
--
-- Table structure for table `ped_dados_gerais`
--
...
CREATE TABLE `ped_dados_gerais` (
  ...
  KEY `ped_dados_gerais_idx1` (`numero_pedido`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ped_dados_gerais`
--

LOCK TABLES `ped_dados_gerais` WRITE;
/*!40000 ALTER TABLE `ped_dados_gerais` DISABLE KEYS */;
/*!40000 ALTER TABLE `ped_dados_gerais` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-08-05  9:53:52
